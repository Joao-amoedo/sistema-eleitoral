...
public class TesteRubro {
	public static void main(String[] args) {
		...
		Eleitor el1 = new Eleitor(UF.MA, 1, 0, cand1, cand2);
		Eleitor el2 = new Eleitor(UF.MA, 2, 0, cand1, cand2);
		Eleitor el3 = new Eleitor(UF.MA, 3, 0, cand1, cand2);
		Eleitor el4 = new Eleitor(UF.MA, 4, 0, cand1, cand2);
		Random rand = new Random();
		int qtd = 150;
		for (int x = 1; x <= qtd; x++) {
			ab.add(new Eleitor(UF.MA, rand.nextLong(), 0, cand1, cand2));
		}
